...
class EatingDisorderTipsBodyAppRoute extends GoRouteData {
  const EatingDisorderTipsBodyAppRoute();

  @override
  Widget build(BuildContext context) => const EatingDisorderTipsBodyAppScreen();
}

class EatingDisorderTipsBodyAppScreen extends StatelessWidget {
  const EatingDisorderTipsBodyAppScreen({super.key});
  @override
