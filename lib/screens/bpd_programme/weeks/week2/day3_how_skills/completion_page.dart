    ...
    return DayPageBase(
      ...
      content: Column(
        children: [
          ...
          Text(
            'Naučil/a si sa 3 základné How skills mindfulness.',
            style: TextStyle(
              fontSize: 16,
              color: isDarkMode
                  ? Colors.white70
          ...
          InfoBox(
            ...
            title: 'Tip na zajtra',
            text: 'Skús byť mindful aspoň v jednej bežnej situácii počas dňa.',
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Dýchacie techniky pre upokojenie mysle',
                  style: TextStyle(
                    fontSize: 14,
                    color: isDarkMode
                        ? Colors.white70
