...
ChatContactSubList _$ChatContactSubListFromJson(Map<String, dynamic> json) => ChatContactSubList(
...
Map<String, dynamic> _$ChatContactSubListToJson(ChatContactSubList instance) => <String, dynamic>{
...
Map<String, dynamic> _$SubChatContactToJson(_SubChatContact instance) => <String, dynamic>{
  'title': instance.title,
  'url': instance.url,
};
